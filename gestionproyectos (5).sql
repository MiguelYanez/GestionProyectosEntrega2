...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2022 a las 16:34:46
...
(9, 'El proyecto debe estar vinculado con la municipalidad de quintero', 2),
(9, 'Las personas encargadas de la seguridad deben tener una identificación hecha por la municipalidad', 3),
(9, 'El trabajo vinculado debe concretarse a lo mas en 1 semana', 4);
...
(12, 9, 'Plan contextualizado sin informes', 'Informacion', 'No hay un plan de contextualización y puede ser perjudicial para la municipalidad si no existen respaldos de documentos', 'evitar', 'medio', 'amenaza', 30, 'aceptable', 2, 'alto', 'Crear documentos en el menor tiempo posible'),
...
(14, 10, 'Problemas con el servidor 2', 'Manutencion', 'Nos falta dinero para pagar la renta del servidor', 'aceptar', 'medio', 'amenaza', 30, 'moderadamente critico', 3, 'medio', 'Pagar la cuota del servidor cuanto antes');
...
--
ALTER TABLE `formulario_aceptar`
  MODIFY `id_formulario_aceptar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `formulario_compartir`
--
ALTER TABLE `formulario_compartir`
  MODIFY `id_formulario_compartir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `formulario_escalar`
--
ALTER TABLE `formulario_escalar`
  MODIFY `id_formulario_escalar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `formulario_explotar`
--
ALTER TABLE `formulario_explotar`
  MODIFY `id_formulario_explotar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `formulario_mejorar`
--
ALTER TABLE `formulario_mejorar`
  MODIFY `id_formulario_mejorar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
